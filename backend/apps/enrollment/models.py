"""
Enrollment models - Semester, Enrollment, Payment Buckets, Documents, and re-exports.
Split models: models_grading.py (GradeHistory, SemesterGPA, GradeResolution)
...
# EPIC 5 Grade & GPA models → moved to models_grading.py
# EPIC 4 Payment & Exam Permit models → moved to models_payments.py
...
# GradeResolution → moved to models_grading.py
