"""
Academic services — Curriculum and Section business logic, plus re-exports.
Split services: services_scheduling.py (SchedulingService)
                services_professor.py (ProfessorService)
"""
...
# SchedulingService → moved to services_scheduling.py
# ProfessorService → moved to services_professor.py
...
# ============================================================
# Backward-compatible re-exports from split service files
# ============================================================
from .services_scheduling import SchedulingService  # noqa: E402, F401
from .services_professor import ProfessorService  # noqa: E402, F401
