"""
Django base settings for Richwell Colleges Portal.
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Richwell Colleges Portal API',
    'DESCRIPTION': 'API documentation for Richwell Colleges student portal',
    'VERSION': '1.0.0',
...
SYSTEM_CONFIG = {
    'ENROLLMENT_LINK_ENABLED': config('ENROLLMENT_LINK_ENABLED', default=True, cast=bool),
    'MAX_UNITS_PER_SEMESTER': 30,
    'INC_EXPIRY_MAJOR_MONTHS': 6,
    'INC_EXPIRY_MINOR_MONTHS': 12,
    'PAYMENT_MONTHS_PER_SEMESTER': 6,
}
