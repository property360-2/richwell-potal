...
const Header = () => {
    ...
    const navigation = [
        ...
        { name: 'Students', href: '/head/students', icon: Users, roles: ['DEPARTMENT_HEAD', 'ADMIN'] },
        { name: 'Resolutions', href: '/head/resolutions', icon: Shield, roles: ['DEPARTMENT_HEAD', 'ADMIN', 'REGISTRAR'] },
