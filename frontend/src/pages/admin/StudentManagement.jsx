...
const StudentManagement = () => {
  ...
  return (
    <div className="page-container space-y-8 p-6">
      <div className="page-header flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-slate-100">
      ...
      <Card className="overflow-hidden border-none shadow-xl">
        ...
        {totalPages > 1 && (
          <div className="pagination-wrapper px-6 py-4 border-t border-slate-100 flex justify-between items-center bg-slate-50/30">
