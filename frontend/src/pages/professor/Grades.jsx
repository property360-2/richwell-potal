...
const ProfessorGrades = () => {
    ...
    const [selectedSS, setSelectedSS] = useState(null); // Selected SectionSubject
    const [students, setStudents] = useState([]);
    const [loadingStudents, setLoadingStudents] = useState(false);
    const [activeTab, setActiveTab] = useState('current'); // current, archives
    ...
    const handleGradeSubmit = async (studentId, gradeValue) => {
        ...
        try {
            ...
            // Default status logic based on grade value
            let status = 'ENROLLED';
            ...
            if (res && res.success) {
                ...
                // Refresh specific student in list
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-gray-900 tracking-tighter">
                            {selectedSS ? 'Section Grading' : 'Assigned Load'}
                        </h1>
