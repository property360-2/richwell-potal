...
import { Users, FileCheck, FileText, Layers, History, ClipboardList, Repeat, GraduationCap } from 'lucide-react';
...
const RegistrarDashboard = () => {
    ...
    const operations = [
        { title: 'Doc Verification', desc: 'Verify credentials and issue official CORs.', icon: <FileCheck className="text-amber-500" />, path: '/registrar/verification', color: 'bg-amber-50' },
        ...
        { title: 'Grade Finalization', desc: 'Review grades and export term masterlists.', icon: <ClipboardList className="text-blue-500" />, path: '/registrar/grades', color: 'bg-blue-50' },
        { title: 'Subject Crediting', desc: 'Credit subjects for transferee students.', icon: <Repeat className="text-emerald-500" />, path: '/registrar/crediting', color: 'bg-emerald-50' },
        { title: 'Historical Encode', desc: 'Backfill academic history for legacy students.', icon: <History className="text-rose-500" />, path: '/registrar/historical-encode', color: 'bg-rose-50' },
        { title: 'Graduation Audit', desc: 'Check eligibility and mark graduates.', icon: <GraduationCap className="text-indigo-500" />, path: '/registrar/reports/graduation', color: 'bg-indigo-50' }
    ];
