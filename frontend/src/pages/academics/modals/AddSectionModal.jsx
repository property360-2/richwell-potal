...
const AddSectionModal = ({ isOpen, onClose, onSuccess, programs, semesters }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            setErrors({ submit: err.message || 'Failed to create section' });
        } finally {
                ...
                <div className="bg-indigo-600 p-10 relative overflow-hidden">
                    ...
                    <div className="relative flex justify-between items-start">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-white tracking-tight">Create Section</h2>
                ...
                <form onSubmit={handleSubmit} className="p-10">
                    ...
                    <div className="mt-10 flex gap-4">
                        ...
                        <Button 
                            ...
                            className="flex-[2] rounded-[22px] py-4 h-auto shadow-xl shadow-indigo-100 flex items-center justify-center gap-3 group"
                        >
                            {isSubmitting ? (
                            ...
                            <span className="font-black uppercase tracking-widest text-[11px]">
                                {isSubmitting ? 'Creating...' : 'Finalize Section'}
                            </span>
                        </Button>
                    </div>
                </form>
