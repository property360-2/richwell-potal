                                            ...
                                            <div className="h-full bg-gray-50/50 p-6 rounded-[32px] border border-gray-100 flex flex-col">
                                                ...
                                                <div className="flex-grow overflow-y-auto max-h-[350px] space-y-2 pr-2 custom-scrollbar">
                                                    ...
                                                    {availableSubjects.filter(s => !selectedPrereqs.find(p => p.id === s.id)).map(subject => (
                                                        ...
                                                        >
                                                            <div>
                                                                <p className="text-xs font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">{subject.code}</p>
                                                                <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest truncate max-w-[120px]">{subject.title}</p>
                                                            </div>
