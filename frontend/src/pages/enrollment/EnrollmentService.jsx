    ...
    async loadEnrollmentData() {
        ...
        try {
            ...
            return {
                ...
                enrollmentStatus,
                fees,
                recommendedSubjects: recommended?.recommended_subjects || recommended || [],
                availableSubjects: available?.results || available || [],
                enrolledSubjects: enrolled?.subject_enrollments || enrolled?.results || enrolled || [],
                // Pass through metadata if present
                currentUnits: recommended?.current_units || enrolled?.enrolled_units || 0,
                maxUnits: recommended?.max_units || student?.max_units || 24
            };
        } catch (e) {
