  ...
  app.innerHTML = `
    <div class="min-h-screen py-8 px-4">
      ...
      <div class="text-center mt-12 text-gray-500 text-sm">
        <p>Already have an account? <a href="/pages/auth/login.html" class="text-blue-600 hover:underline font-medium">Login here</a></p>
      </div>
    </div>
  `;
  ...
  return `
    <div class="min-h-screen flex items-center justify-center p-4">
      <div class="card max-w-md text-center">
        ...
        <a href="/pages/auth/login.html" class="btn-secondary inline-block">Go to Login</a>
      </div>
    </div>
  `;
}
